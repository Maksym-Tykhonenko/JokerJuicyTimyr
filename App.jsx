...
import { Image, ImageBackground, ScrollView, Animated, View } from 'react-native';
...
import FruitDetailScreen from "./src/screens/FruitDetailScreen";
import AddFruitScreen from "./src/screens/AddFruitScreen";
import MyFruitDetailScreen from "./src/screens/MyFruitDetailScreen";
import AllFactsScree from "./src/screens/AllFactsScree";
import AboutDeveloperScreen from "./src/screens/AboutDeveloperScreen";
import JokerJuicyProdScr from './src/screens/JokerJuicyProdScr';
...
export default function App() {
  ...
  const URL_IDENTIFAIRE = `c8ih3RUd`;
  ...
  OneSignal.initialize('1f5030f6-c81c-4164-b039-d423f157a9fd');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-07-10T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="JokerJuicyProdScr"
            component={JokerJuicyProdScr}
    ...
    return (
            ...
            <Stack.Navigator screenOptions={{
              ...
              <Stack.Screen name="FruitDetail" component={FruitDetailScreen} options={{ headerShown: false }} />
              <Stack.Screen name="AddFruitScreen" component={AddFruitScreen} options={{ headerShown: false }} />
              <Stack.Screen name="MyFruitDetailScreen" component={MyFruitDetailScreen} options={{ headerShown: false }} />
              <Stack.Screen name="AllFactsScree" component={AllFactsScree} options={{ headerShown: false }} />
        ...
        {!louderPrevIsEnded || !aceptTransperency ? (
          <View style={{ flex: 1, }}>
            <ImageBackground
              ...
              source={require('./src/assets/new/LoadingPage.png')}
            >
              <Animated.Image
                style={{
                  width: 250,
                  height: 350,
                  opacity: appearingSecondAnim,
                  alignSelf: 'center', // щоб центровано
                }}
                source={require('./src/assets/new/logo77.png')}
              />
            </ImageBackground>
